...
const translations = {
  en: {
    ...
    proStaffLimitHint: "Free: up to 10 staff · Upgrade for more",
  ...
  th: {
    ...
    uploadExcelTruncated: "นำเข้าแค่ {count} จาก {total} คน (แผน Free จำกัด 10 คน) อัพเกรด Pro เพื่อเพิ่มได้",
    ...
    proStaffLimitHint: "ฟรี: สูงสุด 10 คน · อัพเกรดเพื่อเพิ่มได้",
