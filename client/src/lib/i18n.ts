...
const translations = {
  ...
  th: {
    ...
    // HomePage
    heroTitle1: "โปรแกรมจัดตารางเวร สำหรับโรงพยาบาล",
    heroTitle2: "เปลี่ยนความยุ่งยากของทุกเดือนให้เป็นเรื่องง่าย",
    heroDesc: "โปรแกรมจัดตารางเวรที่ช่วยให้พยาบาลและบุคลากรทางการแพทย์จัดเวรได้อย่างยุติธรรม\nรองรับเงื่อนไขที่หลากหลาย ระบบคำนวณและจัดสรรเวรให้สมดุลโดยอัตโนมัติ",
    ...
    whatIsTitle: "โปรแกรมจัดตารางเวร Shift Optimizer คืออะไร?",
    ...
    faqTitle: "คำถามที่พบบ่อยเกี่ยวกับโปรแกรมจัดตารางเวร",
