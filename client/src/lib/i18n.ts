...
const translations = {
  en: {
    ...
    consecutiveDesc: "Prevent staff from working specific shift combinations. Use 'next day' for cross-day rules (e.g., Night → Morning) and 'same day' for overlapping shifts (e.g., 9-22 with Morning).",
    no: "NO",
    followedBy: "followed by (next day)",
    sameDayWith: "same day as",
    ...
    optimizedWithViolations: "Some rules violated",
    levelViolationsFound: "Level staffing requirements not fully met",
    ...
    proceedWithHardLevels: "Force Hard Constraints",
    proceedWithOptimization: "Proceed with Optimization",
    ...
    hardLevelNote: "Level requirements are enforced as strict constraints. The optimizer may not find a feasible schedule if there aren't enough staff.",
    unmetLevelWarning: "Some shifts could not meet the minimum staff level requirements. Review the schedule for details.",
    levelViolationTitle: "Staff level violations detected",
    levelViolationItem: "Day {day} {shift}: {level} = {actual} (min {required})",
    levelConstraintsSkippedTitle: "Level constraints relaxed",
    levelConstraintsSkippedDesc: "The minimum staff level requirements could not be fully satisfied (not enough staff of required levels). The schedule was generated without strict level constraints. Please review the level violations below.",
    andMore: "{count} more...",
  ...
  th: {
    ...
    consecutiveDesc: "ป้องกันบุคลากรทำเวรบางประเภทร่วมกัน ใช้ 'วันถัดไป' สำหรับกฎข้ามวัน (เช่น ดึก→เช้า) และ 'วันเดียวกัน' สำหรับเวรที่เวลาซ้อนกัน (เช่น 9-22 กับ เช้า)",
    no: "ห้าม",
    followedBy: "ตามด้วย (วันถัดไป)",
    sameDayWith: "และ (วันเดียวกัน)",
    ...
    optimizedWithViolations: "ละเมิดบางเงื่อนไข",
    levelViolationsFound: "จำนวนบุคลากรตามระดับไม่ครบตามที่กำหนด",
    imbalanced: "ไม่สมดุล",
    ...
    proceedWithHardLevels: "บังคับเป็นเงื่อนไขตายตัว",
    proceedWithOptimization: "จัดเวรต่อ",
    ...
    hardLevelNote: "ระดับบุคลากรขั้นต่ำเป็นเงื่อนไขตายตัว หากบุคลากรไม่เพียงพอ ระบบอาจไม่สามารถจัดเวรได้",
    unmetLevelWarning: "บางเวรไม่สามารถจัดบุคลากรตามระดับขั้นต่ำได้ครบ กรุณาตรวจสอบตาราง",
    levelViolationTitle: "พบการละเมิดเงื่อนไขระดับบุคลากร",
    levelViolationItem: "วันที่ {day} {shift}: {level} = {actual} (ขั้นต่ำ {required})",
    levelConstraintsSkippedTitle: "ผ่อนปรนเงื่อนไขระดับบุคลากร",
    levelConstraintsSkippedDesc: "ไม่สามารถจัดบุคลากรตามระดับขั้นต่ำที่กำหนดได้ (บุคลากรระดับที่ต้องการมีไม่เพียงพอ) ระบบจัดเวรโดยไม่บังคับเงื่อนไขระดับ กรุณาตรวจสอบรายการละเมิดด้านล่าง",
    andMore: "อีก {count} รายการ...",
