...
const translations = {
  en: {
    ...
    featureSectionTitle: "Why Choose Us",
    featureSectionDesc: "Key features that make shift scheduling effortless",
  ...
  th: {
    ...
    featureSectionTitle: "ทำไมต้องเลือกเรา",
    featureSectionDesc: "จุดเด่นที่ทำให้การจัดเวรเป็นเรื่องง่าย",
