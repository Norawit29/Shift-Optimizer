...
const translations = {
  en: {
    ...
    whatIsDesc: "Shift Optimizer is a free, AI-powered shift scheduling software designed specifically for hospitals and healthcare facilities. It uses Mixed Integer Programming (MIP) — the same class of optimization algorithms used in logistics and operations research — to automatically generate fair, balanced duty rosters. The scheduler handles complex real-world constraints including staff availability, consecutive shift rules (both same-day and next-day), maximum working days, weekend and holiday staffing, and multi-level staffing requirements with up to 5 distinct staff levels.",
    whatIsDesc2: "Unlike manual scheduling that takes hours every month, Shift Optimizer runs entirely in your browser using WebAssembly and produces optimized results in seconds. The 2-phase algorithm first maximizes total shift coverage subject to all hard constraints, then minimizes fairness deviations — ensuring no staff member is overloaded while maintaining full coverage. Staff can also request preferred shifts, and the optimizer treats these as hard constraints to honor individual preferences whenever possible.",
    whatIsDesc3: "The workflow is simple: configure your shift structure and timeline, add your team with their availability and preferences, and let the optimizer generate a balanced schedule. The result can be exported to a color-coded Excel file that is ready to print and distribute. Whether you manage a small clinic with a handful of nurses or a large hospital department with dozens of staff members across multiple levels, Shift Optimizer scales to meet your needs.",
    ...
    faq1Q: "How does the scheduling algorithm work?",
    faq1A: "The scheduler uses a 2-phase optimization approach powered by the HiGHS solver (WebAssembly). Phase 1 maximizes total shift coverage subject to hard constraints (blocked dates, consecutive rules, staffing caps). Phase 2 minimizes fairness deviations to ensure balanced workload across all staff. A greedy post-processing pass fills any remaining gaps.",
    faq2Q: "Is Shift Optimizer free to use?",
    faq2A: "Yes, completely free with no hidden fees, subscriptions, or usage limits. Generate unlimited schedules and export to Excel at no cost.",
  ...
  th: {
    ...
    featureSectionTitle: "ฟีเจอร์หลัก",
    featureSectionDesc: "สิ่งที่ระบบจัดการให้คุณ",
    featureSectionSubtitle: "ทำไมถึง Shift Optimizer",
    heroTagline: "AI จัดเวรอัตโนมัติ",
    ...
    howItWorksDesc: "3 ขั้นตอนง่ายๆ สู่ตารางเวรที่สมดุลที่สุด",
    howStep1Title: "ตั้งค่าเวร",
    howStep1Desc: "กำหนดโครงสร้างเวร ช่วงเวลา และจำนวนบุคลากรที่ต้องการในไม่กี่นาที",
    howStep2Title: "เพิ่มคนและเลือกเงื่อนไขการจัดเวร",
    howStep2Desc: "นำเข้าบุคลากร กำหนดวันว่าง วันบล็อก และเวรที่ต้องการ",
    howStep3Title: "สร้างและส่งออก",
    howStep3Desc: "ระบบ AI จะจัดเวรให้ยุติธรรมและส่งออกเป็น Excel ได้ทันที",
    whatIsTitle: "Shift Optimizer คืออะไร?",
    whatIsDesc: "Shift Optimizer คือซอฟต์แวร์จัดตารางเวรอัตโนมัติฟรี ออกแบบมาสำหรับโรงพยาบาลและสถานพยาบาลโดยเฉพาะ ใช้เทคนิค Mixed Integer Programming (MIP) ซึ่งเป็นอัลกอริทึมเดียวกับที่ใช้ในด้านโลจิสติกส์และการวิจัยปฏิบัติการ เพื่อสร้างตารางเวรที่ยุติธรรมและสมดุลโดยอัตโนมัติ รองรับเงื่อนไขจริงที่ซับซ้อน เช่น วันว่างของบุคลากร กฎเวรต่อเนื่อง (ทั้งวันเดียวกันและข้ามวัน) จำนวนวันทำงานสูงสุด เวรวันหยุดและสุดสัปดาห์ และระดับบุคลากรสูงสุด 5 ระดับ",
    whatIsDesc2: "ต่างจากการจัดเวรด้วยมือที่ใช้เวลาหลายชั่วโมงทุกเดือน Shift Optimizer ทำงานทั้งหมดในเบราว์เซอร์ด้วย WebAssembly และให้ผลลัพธ์ที่เหมาะสมที่สุดในไม่กี่วินาที อัลกอริทึม 2 เฟสจะเพิ่มจำนวนเวรที่ครอบคลุมสูงสุดก่อน แล้วจึงลดความเหลื่อมล้ำ เพื่อให้มั่นใจว่าไม่มีบุคลากรคนใดถูกมอบหมายงานมากเกินไป บุคลากรยังสามารถร้องขอเวรที่ต้องการได้ และระบบจะรองรับเป็นเงื่อนไขบังคับ",
    whatIsDesc3: "ขั้นตอนการใช้งานง่ายมาก: ตั้งค่าโครงสร้างเวรและช่วงเวลา เพิ่มทีมงานพร้อมวันว่างและเวรที่ต้องการ แล้วให้ระบบสร้างตารางเวรที่สมดุล ผลลัพธ์ส่งออกเป็นไฟล์ Excel แยกสีพร้อมพิมพ์ได้ทันที ไม่ว่าคุณจะจัดการคลินิกขนาดเล็กหรือแผนกโรงพยาบาลขนาดใหญ่ที่มีบุคลากรหลายสิบคนหลายระดับ Shift Optimizer รองรับได้ทุกขนาด",
    benefitsTitle: "ข้อดี",
    benefit1Title: "ประหยัดเวลาทุกเดือน",
    benefit1Desc: "แทนที่การจัดเวรด้วยมือที่น่าเบื่อด้วยระบบอัตโนมัติ จากหลายชั่วโมงต่อเดือนเหลือเพียงไม่กี่นาที เพิ่มเวลาให้กับการดูแลผู้ป่วยและงานสำคัญอื่นๆ",
    benefit2Title: "ยุติธรรมทุกคน",
    benefit2Desc: "อัลกอริทึมกระจายภาระงานอย่างสมดุลทางคณิตศาสตร์ด้วยการลดค่าเบี่ยงเบน ขจัดอคติ ลดข้อร้องเรียนเรื่องความไม่เป็นธรรม และกระจายเวรวันหยุดอย่างเท่าเทียม",
    benefit3Title: "รองรับกฎที่ซับซ้อน",
    benefit3Desc: "รองรับวันบล็อก เวรที่ร้องขอ กฎเวรต่อเนื่องทั้งวันเดียวกันและข้ามวัน จำนวนวันทำงานต่อเนื่องสูงสุด เวรวันหยุด/สุดสัปดาห์แยกต่างหาก ระดับบุคลากรสูงสุด 5 ระดับพร้อมกำหนดจำนวนขั้นต่ำต่อระดับ และจำนวนเวรสูงสุดต่อคน",
    benefit4Title: "ไม่ต้องติดตั้ง",
    benefit4Desc: "ทำงานในเว็บเบราว์เซอร์ ไม่ต้องติดตั้งซอฟต์แวร์ ไม่ต้องจัดการเซิร์ฟเวอร์ ไม่มีค่าสมาชิก ข้อมูลบุคลากรเป็นส่วนตัว — คำนวณทั้งหมดในเครื่องของคุณ ล็อกอินด้วย Google เพื่อบันทึกและโหลด preset ข้ามเซสชัน",
    faqTitle: "คำถามที่พบบ่อย",
    faq1Q: "อัลกอริทึมการจัดเวรทำงานอย่างไร?",
    faq1A: "ระบบใช้การหาค่าเหมาะสม 2 เฟส ด้วย HiGHS solver (WebAssembly) เฟส 1 เพิ่มจำนวนเวรที่ครอบคลุมสูงสุดภายใต้เงื่อนไขบังคับ เฟส 2 ลดความเหลื่อมล้ำให้น้อยที่สุด จากนั้นมีการเติมเวรที่เหลือด้วย greedy post-processing",
    faq2Q: "Shift Optimizer ใช้ฟรีหรือไม่?",
    faq2A: "ใช่ ฟรีทั้งหมด ไม่มีค่าธรรมเนียมแอบแฝง ไม่มีค่าสมาชิก ไม่จำกัดการใช้งาน สร้างตารางเวรและส่งออก Excel ได้ไม่จำกัด",
    faq3Q: "ระบบรองรับเงื่อนไขอะไรบ้าง?",
    faq3A: "วันบล็อก เวรที่ร้องขอ กฎเวรต่อเนื่องทั้งวันเดียวกันและข้ามวัน จำนวนวันทำงานต่อเนื่องสูงสุด เวรวันหยุด/สุดสัปดาห์แยกต่างหาก ระดับบุคลากรสูงสุด 5 ระดับ และจำนวนเวรสูงสุดต่อคน",
    faq4Q: "ส่งออกตารางเวรได้ไหม?",
    faq4A: "ได้ ส่งออกเป็น Excel พร้อมเซลล์แยกสี ตัวบ่งชี้ระดับบุคลากร และเครื่องหมายเวรที่ร้องขอ พร้อมพิมพ์ได้ทันที",
    faq5Q: "ข้อมูลของฉันเป็นส่วนตัวหรือไม่?",
    faq5A: "ใช่ การคำนวณทั้งหมดทำงานในเบราว์เซอร์ของคุณ ชื่อบุคลากรและข้อมูลตารางเวรจะไม่ถูกส่งไปยังเซิร์ฟเวอร์ใด เว้นแต่คุณเลือกบันทึก preset",
