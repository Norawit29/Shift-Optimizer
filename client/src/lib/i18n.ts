...
const translations = {
  ...
  th: {
    ...
    whatIsDesc: "Shift Optimizer คือซอฟต์แวร์จัดตารางเวรอัตโนมัติฟรี ออกแบบมาสำหรับโรงพยาบาลและสถานพยาบาลโดยเฉพาะ สร้างตารางเวรที่ยุติธรรมและสมดุลโดยอัตโนมัติ รองรับเงื่อนไขจริงที่ซับซ้อน เช่น วันว่างของบุคลากร กฎเวรต่อเนื่อง จำนวนวันทำงานสูงสุด เวรวันหยุดและสุดสัปดาห์ และระดับบุคลากรสูงสุด 5 ระดับ",
    ...
    faq2Q: "บุคลากรสามารถร้องขอเวรที่ต้องการได้ไหม?",
