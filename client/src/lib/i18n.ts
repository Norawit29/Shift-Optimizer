...
const translations = {
  en: {
    ...
    stat1Value: "50",
    stat1Label: "Hospital departments using the system",
    stat2Value: "600",
    stat2Label: "Schedules generated",
    stat3Value: "300",
    stat3Label: "Working days returned to teams",
  ...
  th: {
    ...
    stat1Value: "50",
    stat1Label: "แผนกในโรงพยาบาลที่ใช้งานจริง",
    stat2Value: "600",
    stat2Label: "ตารางเวรที่สร้างแล้ว",
    stat3Value: "300",
    stat3Label: "วันทำงานที่คืนให้ทีม จากการจัดตารางเวร",
