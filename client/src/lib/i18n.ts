...
const translations = {
  en: {
    ...
    tutorialStep3Desc: "Mark days each staff member is unavailable (leave, training, personal requests)\nSet public holidays for the scheduling period",
  ...
  th: {
    ...
    tutorialStep3Desc: "ทำเครื่องหมายวันที่บุคลากรไม่สามารถขึ้นเวรได้ (วันลา วันอบรม วันที่ขอไว้)\nกำหนดวันหยุดนักขัตฤกษ์สำหรับช่วงจัดตาราง",
