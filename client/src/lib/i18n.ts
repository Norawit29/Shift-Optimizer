...
const translations = {
  en: {
    ...
    softLevelNote: "\"Best Effort\" allows some level violations to maximize coverage. \"Force Hard\" enforces all level requirements strictly (some slots may be left unfilled).",
  ...
  th: {
    ...
    softLevelNote: "\"พยายามให้ครบ\" อนุญาตให้ละเมิดจำนวนขั้นต่ำบางช่องเพื่อจัดคนให้ครบ \"บังคับตายตัว\" จัดตามระดับอย่างเคร่งครัด (บางช่องอาจว่าง)",
