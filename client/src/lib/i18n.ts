...
const translations = {
  en: {
    ...
    uploadExcelHint: ".xlsx file — put names in column A, one name per row (no header needed)",
  ...
  th: {
    ...
    uploadExcelHint: "ไฟล์ .xlsx — ใส่ชื่อในคอลัมน์ A แถวละ 1 ชื่อ (ไม่ต้องมีหัวตาราง)",
