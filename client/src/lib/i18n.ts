...
const translations = {
  en: {
    ...
    statsSectionTitle: "Results from Real Departments",
    stat1Value: "50+",
    stat1Label: "Departments Using the System",
    stat2Value: "600+",
    stat2Label: "Schedules Generated",
    stat3Value: "300",
    stat3Label: "Man-days Saved",
  ...
  th: {
    ...
    statsSectionTitle: "ตัวเลขจริงจากการใช้งาน",
    stat1Value: "50+",
    stat1Label: "แผนกที่ใช้งานแล้ว",
    stat2Value: "600+",
    stat2Label: "ตารางเวรที่สร้างแล้ว",
    stat3Value: "300",
    stat3Label: "วันทำงานที่ประหยัดได้",
