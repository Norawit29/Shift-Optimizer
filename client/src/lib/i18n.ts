...
const translations = {
  en: {
    ...
    tutorialStep1Desc: "Set how many shifts per day (e.g. Morning, Afternoon, Night), choose the month or custom date range, specify staff required per shift, configure different staffing for weekends/holidays if needed, and set up staff levels to ensure experienced staff cover every shift.",
  ...
  th: {
    ...
    tutorialStep1Desc: "ตั้งค่าจำนวนเวรต่อวัน (เช่น เช้า บ่าย ดึก) เลือกเดือนหรือช่วงวันที่ต้องการจัดตาราง กำหนดจำนวนบุคลากรที่ต้องขึ้นเวร ตั้งค่าจำนวนคนวันหยุด/สุดสัปดาห์หากต่างจากวันธรรมดา และกำหนดระดับบุคลากร เช่น กรณีพยาบาลที่มีประสบการณ์ต่างกัน เพื่อให้มีคนอาวุโส cover ทุกเวร",
