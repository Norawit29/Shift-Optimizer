...
const translations = {
  en: {
    ...
    tutorialStep4Desc: "The optimizer creates a fair schedule respecting all constraints\nMaximizes coverage first, then balances workload evenly\nReview the result and make adjustments if needed",
  ...
  th: {
    ...
    tutorialStep4Desc: "ระบบจะสร้างตารางเวรที่ยุติธรรมโดยอัตโนมัติ\nจัดให้ครบจำนวนมากที่สุดก่อน แล้วกระจายเวรให้สมดุล\nตรวจสอบผลลัพธ์และปรับแก้ได้ตามต้องการ",
