...
const translations = {
  en: {
    ...
    caseStudiesSubtitle: "Real-world examples of how hospitals use our scheduling system",
    caseStudiesEmpty: "No case studies yet. Check back soon!",
    ...
    statsSectionLabel: "IMPACT",
    statsSectionTitle: "Helping hospital teams reclaim their time",
    stat1Value: "40",
    stat1Label: "Hospital departments\nusing the system",
    stat2Value: "600",
    stat2Label: "Schedules generated",
    stat3Value: "300",
    stat3Label: "Working days returned\nto teams",
    ...
    uploadExcelTruncated: "Imported first {count} of {total} (Free plan limit: 15 staff). Upgrade to Pro for unlimited.",
    ...
    wkShiftDetailsTitle: "Shift names, staffing & hours",
    wkShiftDetailsDesc: "Name each shift, set how many staff are needed, and specify the working hours for each shift.",
  ...
  th: {
    ...
    caseStudiesSubtitle: "ตัวอย่างการใช้งานจริงของระบบจัดตารางเวรในโรงพยาบาล",
    caseStudiesEmpty: "ยังไม่มีกรณีศึกษา กลับมาเร็วๆ นี้!",
    ...
    statsSectionLabel: "ผลลัพธ์",
    statsSectionTitle: "ช่วยลดภาระงานและคืนเวลาให้ทีมในโรงพยาบาล",
    stat1Value: "40",
    stat1Label: "แผนกในโรงพยาบาล\nที่ใช้งานจริง",
    stat2Value: "600",
    stat2Label: "ตารางเวรที่สร้างแล้ว",
    stat3Value: "300",
    stat3Label: "วันทำงานที่คืนให้ทีม\nจากการจัดตารางเวร",
    ...
    uploadExcelTruncated: "นำเข้าแค่ {count} จาก {total} คน (แผน Free จำกัด 15 คน) อัพเกรด Pro เพื่อไม่จำกัด",
    ...
    proGateDesc: "ฟีเจอร์นี้สำหรับผู้ใช้ Pro เท่านั้น อัพเกรดเพื่อเพิ่มจำนวนบุคลากรสูงสุด 50 คน เพิ่มเวรได้มากขึ้น เกลี่ยวันหยุด ตารางรายบุคคล และส่งออก Excel",
    ...
    wkShiftDetailsTitle: "ตั้งชื่อเวร จำนวนบุคลากร และชั่วโมง",
    wkShiftDetailsDesc: "ตั้งชื่อเวรแต่ละเวร กำหนดจำนวนคนที่ต้องขึ้นเวร และจำนวนชั่วโมงทำงานในแต่ละเวร",
