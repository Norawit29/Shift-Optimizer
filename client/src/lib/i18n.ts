...
const translations = {
  ...
  th: {
    ...
    whatIsDesc: "Shift Optimizer คือซอฟต์แวร์จัดตารางเวรอัตโนมัติ ออกแบบมาสำหรับโรงพยาบาลและสถานพยาบาลโดยเฉพาะ สร้างตารางเวรที่ยุติธรรมและสมดุลโดยอัตโนมัติ รองรับเงื่อนไขจริงที่ซับซ้อน เช่น วันว่างของบุคลากร กฎเวรต่อเนื่อง จำนวนวันทำงานสูงสุด เวรวันหยุดและสุดสัปดาห์ และระดับบุคลากรสูงสุด 5 ระดับ",
    whatIsDesc2: "ต่างจากการจัดเวรด้วยมือที่ใช้เวลาหลายชั่วโมงทุกเดือน Shift Optimizer ทำงานทั้งหมดในเบราว์เซอร์และให้ผลลัพธ์ในไม่กี่วินาที ระบบจะเติมเวรให้ครบก่อน แล้วจึงกระจายภาระงานให้สมดุล เพื่อให้มั่นใจว่าไม่มีใครถูกมอบหมายงานมากเกินไป บุคลากรยังสามารถร้องขอเวรที่ต้องการได้ และระบบจะจัดให้ตามที่ขอ",
    whatIsDesc3: "ขั้นตอนการใช้งานง่ายมาก: ตั้งค่าโครงสร้างเวร เพิ่มทีมงานพร้อมวันว่างและเวรที่ต้องการ แล้วให้ระบบสร้างตารางเวรที่สมดุล ส่งออกเป็นไฟล์ Excel แยกสีพร้อมพิมพ์ได้ทันที ไม่ว่าคุณจะจัดการคลินิกขนาดเล็กหรือแผนกโรงพยาบาลขนาดใหญ่ Shift Optimizer รองรับได้ทุกขนาด",
    benefitsTitle: "ข้อดี",
    ...
    faq1Q: "ระบบรองรับบุคลากรได้กี่คน?",
    ...
    faq2Q: "บุคลากรสามารถขออยู่เวรที่ต้องการได้หรือไม่?",
    faq2A: "ได้ บุคลากรแต่ละคนสามารถเลือกเวรที่ต้องการในปฏิทิน และระบบจะจัดให้ตามที่ขอ นอกจากนี้ยังสามารถบล็อกวันที่ไม่ว่างได้ด้วย",
