...
const config: SEOPageConfig = {
  ...
  logoSubtitle: "ระบบจัดตารางเวร",
  accentTheme: "business",
  badge: "สำหรับธุรกิจบริการทุกขนาด",
  h1Line1: "โปรแกรมจัดเวรพนักงาน",
  h1Line2: "สำหรับธุรกิจบริการ",
  h1Gradient: "จัดเวรให้พอทุกช่วงพีค ประหยัดเวลาจัดเวรด้วย AI",
