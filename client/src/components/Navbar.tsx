          ...
          <div className="hidden lg:flex items-center gap-1">
            {sectionLinks.map((item) => (
              <a
                ...
                className="px-2.5 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary transition-colors rounded-lg whitespace-nowrap"
            ...
            {isArticlesActive ? (
              <span className="px-2.5 py-2 text-sm font-semibold text-primary rounded-lg whitespace-nowrap" data-testid="nav-link-articles-active">
                {t.navArticles}
              </span>
            ) : (
              <Link href="/articles" className="px-2.5 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary transition-colors rounded-lg whitespace-nowrap" data-testid="nav-link-articles">
                {t.navArticles}
              </Link>
            )}
          </div>
