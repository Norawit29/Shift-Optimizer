...
export function ScheduleEditor({
  ...
  const handleDrop = useCallback(
    (e: React.DragEvent, targetDayDate: number, targetShiftIdx: number) => {
      ...
      if (warnings.length > 0) {
        ...
        toast({
          title: t.editorConstraintWarning,
    ...
    [schedule, config, staff, month, year, t, toast, onScheduleChange]
  );
  ...
  return (
    <div className="flex gap-4" data-testid="schedule-editor">
      <div className={cn("flex-1 min-w-0", sidebarOpen ? "max-w-[calc(100%-280px)]" : "")}>
      ...
      <div className="shrink-0 flex flex-col gap-2">
        ...
        {sidebarOpen && (
          <Card className="w-[260px] border shadow-lg bg-white dark:bg-zinc-900" data-testid="staff-panel">
                ...
                {staff.map((s, idx) => {
                  ...
                  return (
                    <div
                      ...
                      onDragEnd={handleDragEnd}
                      className={cn(
                        "flex items-center gap-2 p-2 rounded-md cursor-grab active:cursor-grabbing hover-elevate",
                      ...
                      <div className="flex gap-0.5 shrink-0">
                        {config.shiftNames.map((shiftName, si) => (
                          <div
                            ...
                            title={shiftName}
                          >
                            <div className="text-[9px] text-muted-foreground truncate max-w-[28px]">
                              {shiftName.slice(0, 2)}
                            </div>
